                ...
                {showPicker && (
                    ...
                    >
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                            <h5 style={{ fontSize: '0.8rem', color: 'var(--primary)' }}>கிரகங்களைத் தேர்ந்தெடுக்கவும் (Select Planets)</h5>
                            <X size={16} cursor="pointer" onClick={() => setShowPicker(false)} />
                        </div>
                        ...
                        <button
                            ...
                            style={{ marginTop: '1rem', background: '#334155', color: 'white' }}
                        >
                            சரி (Done)
                        </button>
                    </motion.div>
...
const ChartInput = ({ title, chartData, onChange }) => {
    ...
    return (
        <div style={{ marginBottom: '1.5rem' }}>
            <label style={{ justifyContent: 'center', marginBottom: '0.5rem' }}>{title}</label>
            <div style={{
                display: 'grid',
